...
/**
 * Determine if str stars with prefix.
 *
 * @param {String} str
 * @param {String} prefix
 * @return {Boolean}
...
/**
 * Trim slashes from both ends of string.
 *
 * @param {String} str
 * @return {String}
 * @api private
...
/**
 * Build URL from strings
 *
 * @param {String} base
 * @param {String} path
 * @param {Boolean} useTrailingSlash
 * @return {String}
 * @api private
 */
export function buildURL(base, path, useTrailingSlash) {
	const _base = trimSlashes(base);
