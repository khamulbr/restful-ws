import { isAbsoluteUrl, parseResponseText, parseHeaders, replaceWindowLocation } from './utils.js';
 ...
 * @param {Resource} resti.Resource object
...
class Response {
	...
	constructor(method, xhr, resource) {
		this.method = method;
	...
	parse() {
		...
		return this.resource.parser ? this.resource.parser(this.xhr.responseText, this) : parseResponseText(this.xhr);
	}	
	...
	*/
	setStatus(status) {
		...
		this.error = (this.clientError || this.serverError) ? true : false;
