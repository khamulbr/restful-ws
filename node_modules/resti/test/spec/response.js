describe('resti response', function () {
    var swapi;
    var OKResp = {
		'status': 200,
		'statusText': 'ok',
    ...
    beforeEach(function () {
        ...
        swapi = new resti('http://swapi.co/api/');
    });
    ...
    describe('should call callback', function() {
    	...
    	it('with resti.Response', function() {
    		var res = doneFn.calls.mostRecent().args[0];
    		expect(res).toEqual(jasmine.any(resti.Response));
    	});
